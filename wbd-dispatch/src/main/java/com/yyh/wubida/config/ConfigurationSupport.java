...
import com.itheima.pinda.common.converter.EnumDeserializer;
import com.yyh.wubida.common.json.BigDecimalSerializer;
...
public class ConfigurationSupport extends WebMvcConfigurationSupport {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.yyh.wubida.controller"))
