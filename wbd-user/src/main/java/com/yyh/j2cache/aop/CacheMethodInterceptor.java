package com.yyh.j2cache.aop;

import com.yyh.j2cache.annotation.Cache;
import com.yyh.j2cache.annotation.CacheEvictor;
import com.yyh.j2cache.aop.processor.AbstractCacheAnnotationProcessor;
import com.yyh.j2cache.aop.processor.CacheEvictorAnnotationProcessor;
import com.yyh.j2cache.aop.processor.CachesAnnotationProcessor;
import com.yyh.j2cache.utils.SpringApplicationContextUtils;
...
public class CacheMethodInterceptor implements Interceptor{
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.yyh.j2cache.annotation.Cache)")//环绕通知
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.yyh.j2cache.annotation.CacheEvictor)")//环绕通知
